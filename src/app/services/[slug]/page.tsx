    ...
    <>
      <section className="bg-[#1B3A5C] text-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          <Link href="/services" className="text-[#a0b4c8] text-sm hover:text-white transition-colors mb-6 inline-block">← Back to Services</Link>
          ...
          {service.tagline && <p className="text-[#a0b4c8] text-xl max-w-xl">{service.tagline}</p>}
        </div>
      </section>
      ...
      <section className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              {service.description && <p className="text-[#374151] text-lg leading-relaxed">{service.description}</p>}
            </div>
