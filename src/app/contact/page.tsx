...
export const metadata: Metadata = {
  title: "Contact",
  description: "Book a free 30-minute workflow audit. No commitment, no pitch — just honest advice about how to run your trade business tighter.",
};
      ...
      <section className="bg-[#1B3A5C] text-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-[#a0b4c8] text-xl max-w-xl">
            Start with a free 30-minute audit. We&apos;ll tell you exactly where your operation is leaking time — no obligation.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              <h2 className="text-2xl font-black text-[#1B3A5C] mb-6">Book a Free Audit</h2>
              <form className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-[#E5E7EB] rounded px-4 py-3 text-sm focus:outline-none focus:border-[#1B3A5C] transition-colors"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    placeholder="Paperwork, scheduling, invoicing, something else..."
                    className="w-full border border-[#E5E7EB] rounded px-4 py-3 text-sm focus:outline-none focus:border-[#1B3A5C] transition-colors resize-none"
                  />
                </div>
                <button
                  type="submit"
                  className="w-full bg-[#F5C518] text-[#1B3A5C] font-bold py-4 rounded text-lg hover:bg-[#D4A800] transition-colors"
                >
                  Request Free Audit
                </button>
              </form>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-[#F8F8F8] rounded-lg p-6">
                <p className="text-sm text-[#6B7280] italic">
                  &ldquo;We&apos;re not going to hard sell you on anything. If we can&apos;t help, we&apos;ll tell you that too.&rdquo;
                </p>
              </div>
            </div>
          </div>
